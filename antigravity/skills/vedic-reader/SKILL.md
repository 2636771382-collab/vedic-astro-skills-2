...
- 只用D1+宫主表即可推导（深度分析是core的工作）
- 5条覆盖不同领域（性格/事业/感情/转折点/压力）
- 措辞要自信、专业，像真正的占星师
```
...
1. 您给人的第一印象是[Lagna星座特质]，但内心深处更倾向于[Moon星座特质]
2. 在[大运行星]大运期间（YYYY-YYYY），您经历过一次[对应宫位含义]方面的重大转变
3. 您在[强星落宫领域]方面有明显的天赋或优势，但[弱星领域]一直是短板
4. [Saturn位置]给您带来了持续的[压力领域]方面的压力
5. 您的[4宫/9宫特质相关]早年/家庭经历有[特征]

请逐条回复：准 / 不准 / 部分准

另外，如果您有补充信息（比如重要人生事件的大致时间、
婚姻/职业变动等），也请在这里告诉我，有助于提高后续分析精度。
```
...
3/5准  → 时间可信度=中，继续但标注
<3/5准 → 时间可信度=低
  → 推荐："验前事命中率偏低，建议运行时间校准以获得更精确的分析。
     说'校准时间'即可启动，大约需要您提供5个重大人生事件。
     如果您选择不校准，分析将基于当前时间进行，部分高敏感分盘会降级处理。"
